...
from apps.oms.models import Order, Execution
...
class LearningService:
    ...
    def record_trade_outcome(cls, order: Order):
        ...
        performance.save()
        logger.info(f"Updated performance for {performance.setup_type}: {performance.success_rate}% success")

    @classmethod
    def get_setup_adjustment(cls, tenant: Tenant, instrument, setup_type: str, timeframe: str) -> float:

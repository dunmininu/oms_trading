...
from apps.api.schemas import DateRangeFilterSchema, StatusFilterSchema
...
class StrategyDefinitionCreateSchema(Schema):
    ...
    description: str | None = Field(description="Strategy description")
    ...
    max_position_size: Decimal | None = Field(description="Maximum position size")
    max_drawdown: Decimal | None = Field(description="Maximum drawdown percentage")
    ...
    rebalance_frequency: str = Field(
        description="Rebalance frequency (DAILY, WEEKLY, etc.)"
    )

    # Risk management
    stop_loss: Decimal | None = Field(description="Stop loss percentage")
    take_profit: Decimal | None = Field(description="Take profit percentage")
    max_slippage: Decimal | None = Field(description="Maximum slippage tolerance")

    # Metadata
    tags: list[str] | None = Field(description="Strategy tags")
...
class StrategyDefinitionUpdateSchema(Schema):
    ...
    name: str | None = Field(description="Strategy name")
    description: str | None = Field(description="Strategy description")
    version: str | None = Field(description="Strategy version")

    # Strategy configuration
    strategy_type: str | None = Field(description="Strategy type")
    risk_profile: str | None = Field(description="Risk profile")
    max_position_size: Decimal | None = Field(description="Maximum position size")
    max_drawdown: Decimal | None = Field(description="Maximum drawdown percentage")

    # Trading parameters
    instruments: list[str] | None = Field(description="List of instrument symbols")
    trading_hours: dict[str, Any] | None = Field(
        description="Trading hours configuration"
    )
    rebalance_frequency: str | None = Field(description="Rebalance frequency")
    ...
    # Status
    is_active: bool | None = Field(description="Whether strategy is active")
...
class StrategyDefinitionResponseSchema(Schema):
    ...
    sharpe_ratio: Decimal | None = Field(description="Sharpe ratio")
    max_drawdown_actual: Decimal | None = Field(description="Actual maximum drawdown")
    ...
    approved_at: datetime | None = Field(description="Approval timestamp")


class StrategyDefinitionFilterSchema(StatusFilterSchema):
    """Strategy definition filter schema."""

    name: str | None = Field(description="Filter by strategy name")
    strategy_type: str | None = Field(description="Filter by strategy type")
    risk_profile: str | None = Field(description="Filter by risk profile")
    user_id: str | None = Field(description="Filter by user")
    is_approved: bool | None = Field(description="Filter by approval status")
    tags: list[str] | None = Field(description="Filter by tags")
...
class StrategyRunCreateSchema(Schema):
    ...
    max_positions: int | None = Field(description="Maximum number of positions")
    ...
    end_date: date | None = Field(
        description="Run end date (optional for ongoing runs)"
    )

    # Metadata
    notes: str | None = Field(description="Run notes")
    metadata: dict[str, Any] | None = Field(description="Additional metadata")
...
class StrategyRunUpdateSchema(Schema):
    ...
    end_date: date | None = Field(description="Run end date")
    max_position_size: Decimal | None = Field(description="Maximum position size")
    max_drawdown: Decimal | None = Field(description="Maximum drawdown percentage")

    # Status
    is_active: bool | None = Field(description="Whether run is active")
...
class StrategyRunResponseSchema(Schema):
    ...
    max_positions: int | None = Field(description="Maximum positions")
    max_position_size: Decimal | None = Field(description="Maximum position size")
    max_drawdown: Decimal | None = Field(description="Maximum drawdown percentage")

    # Schedule
    start_date: date = Field(description="Start date")
    end_date: date | None = Field(description="End date")
    ...
    daily_pnl: Decimal | None = Field(description="Daily P&L")
    daily_return: Decimal | None = Field(description="Daily return percentage")
    ...
    sharpe_ratio: Decimal | None = Field(description="Sharpe ratio")
    sortino_ratio: Decimal | None = Field(description="Sortino ratio")
    ...
    ended_at: datetime | None = Field(description="End timestamp")
    last_trade_at: datetime | None = Field(description="Last trade timestamp")
...
class StrategyRunFilterSchema(StatusFilterSchema, DateRangeFilterSchema):
    ...
    strategy_definition_id: str | None = Field(
        description="Filter by strategy definition"
    )
    broker_account_id: str | None = Field(description="Filter by broker account")
    user_id: str | None = Field(description="Filter by user")
    min_capital: Decimal | None = Field(description="Minimum initial capital")
    max_capital: Decimal | None = Field(description="Maximum initial capital")
...
class StrategyPerformanceResponseSchema(Schema):
    ...
    # Risk metrics
    period_volatility: Decimal | None = Field(description="Period volatility")
    sharpe_ratio: Decimal | None = Field(description="Sharpe ratio")
    sortino_ratio: Decimal | None = Field(description="Sortino ratio")
    max_drawdown: Decimal | None = Field(description="Maximum drawdown")
...
class StrategyPerformanceFilterSchema(DateRangeFilterSchema):
    ...
    period_type: str | None = Field(description="Filter by period type")
    min_return: Decimal | None = Field(description="Minimum return filter")
    max_return: Decimal | None = Field(description="Maximum return filter")
...
class StrategySignalResponseSchema(Schema):
    ...
    # Signal parameters
    target_price: Decimal | None = Field(description="Target price")
    stop_loss: Decimal | None = Field(description="Stop loss price")
    take_profit: Decimal | None = Field(description="Take profit price")
    quantity: Decimal | None = Field(description="Suggested quantity")

    # Signal context
    signal_reason: str = Field(description="Reason for the signal")
    market_conditions: dict[str, Any] = Field(
        description="Market conditions at signal time"
    )

    # Status
    is_executed: bool = Field(description="Whether signal was executed")
    execution_price: Decimal | None = Field(description="Execution price")
    execution_quantity: Decimal | None = Field(description="Execution quantity")

    # Timestamps
    signal_time: datetime = Field(description="Signal generation time")
    executed_at: datetime | None = Field(description="Execution timestamp")
...
class StrategySignalFilterSchema(DateRangeFilterSchema):
    ...
    strategy_run_id: str | None = Field(description="Filter by strategy run")
    signal_type: str | None = Field(description="Filter by signal type")
    instrument_symbol: str | None = Field(description="Filter by instrument")
    is_executed: bool | None = Field(description="Filter by execution status")
    min_confidence: Decimal | None = Field(description="Minimum confidence filter")
...
class BulkStrategyRunCreateSchema(Schema):
    ...
    runs: list[StrategyRunCreateSchema] = Field(
        description="List of strategy runs to create"
    )
...
class BulkStrategyRunResponseSchema(Schema):
    ...
    accepted: list[StrategyRunResponseSchema] = Field(
        description="Successfully created runs"
    )
...
class StrategyDefinitionListResponseSchema(Schema):
    ...
    strategies: list[StrategyDefinitionResponseSchema] = Field(
...
class StrategyPerformanceListResponseSchema(Schema):
    ...
    performances: list[StrategyPerformanceResponseSchema] = Field(

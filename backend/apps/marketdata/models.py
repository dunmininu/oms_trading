...
class MarketSubscription(BaseModel):
    ...
    subscription_type = models.CharField(
        max_length=20, choices=SUBSCRIPTION_TYPE_CHOICES, db_index=True
    )
    ...
    )  # List of fields to subscribe to
...
class TickData(BaseModel):
    ...
    # Tick Details
    tick_type = models.CharField(
        max_length=30, choices=TICK_TYPE_CHOICES, db_index=True
    )
...
class MarketDataCache(BaseModel):
    ...
    cache_type = models.CharField(
        max_length=30, choices=CACHE_TYPE_CHOICES, db_index=True
    )
...
class MarketDataStream(BaseModel):
    ...
    stream_type = models.CharField(
        max_length=20, choices=STREAM_TYPE_CHOICES, db_index=True
    )
    status = models.CharField(
        max_length=20, choices=STATUS_CHOICES, default="ACTIVE", db_index=True
    )
    ...
    subscriptions = models.ManyToManyField(
        MarketSubscription, related_name="data_streams", blank=True
    )
...
class HistoricalData(BaseModel):
    ...
    data_type = models.CharField(
        max_length=20, choices=DATA_TYPE_CHOICES, db_index=True
    )

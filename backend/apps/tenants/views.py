...
class TenantViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return (
            super()
            .get_queryset()
            .filter(tenant_users__user=user, tenant_users__is_active=True)
            .distinct()
        )
...
class TenantUserViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return (
            ...
            .get_queryset()
            .filter(
                tenant__tenant_users__user=user, tenant__tenant_users__is_active=True
            )
            .distinct()
        )

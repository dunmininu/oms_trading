...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            self.stdout.write(
                self.style.SUCCESS(f"Created broker: {broker.display_name}")
            )
        ...
        if created:
            self.stdout.write(
                self.style.SUCCESS(f"Created connection: {connection.name}")
            )
        ...
        if created:
            self.stdout.write(
                self.style.SUCCESS(f"Created broker account: {account.account_number}")
            )
        ...
        if created:
            self.stdout.write(
                self.style.SUCCESS(f"Created broker: {deriv_broker.display_name}")
            )

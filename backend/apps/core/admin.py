...
from .models import AuditLog, HealthCheck, SystemConfiguration, User
...
class SystemConfigurationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("key", "value", "description", "category", "is_public")}),
...
class HealthCheckAdmin(admin.ModelAdmin):
    ...
    list_display = ["component", "status", "response_time_display", "created_at"]
    ...
    fieldsets = (
        (_("Basic Information"), {"fields": ("component", "status", "message")}),
        (
            _("Performance"),
            {"fields": ("response_time_ms", "details"), "classes": ("collapse",)},
        ),
        (
            _("Error Details"),
            {"fields": ("error_traceback",), "classes": ("collapse",)},
        ),
        (
            _("Timestamps"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
